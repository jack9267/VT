...
*/
static const char rcsid[] = "$Id: dyngl.c,v 1.2 2002/09/08 12:19:35 crow Exp $";
 ...
 * are generated from the macros in dglfuncs.h.
 */
#define DYNGL_NEED(ret, name, args) ret (DYNGLENTRY * q##name) args = NULL;
#define DYNGL_EXT(ret, name, args, extension)	ret (DYNGLENTRY * q##name) args = NULL;
#define DYNGL_WANT(ret, name, args, alt) ret (DYNGLENTRY * q##name) args = NULL;
#include "dglfuncs.h"
#undef DYNGL_NEED
#undef DYNGL_EXT
#undef DYNGL_WANT
...
#define DYNGL_NEED(ret, name, args) q##name = NULL;
#define DYNGL_EXT(ret, name, args, extension) q##name = NULL;
#define DYNGL_WANT(ret, name, args, alt) q##name = NULL;
#include "dglfuncs.h"
#undef DYNGL_NEED
#undef DYNGL_EXT
#undef DYNGL_WANT
 ...
 * DynGL_GetFunctions
 *
 * Goes through the list of requested functions in dglfuncs.h and tries to
